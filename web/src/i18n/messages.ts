...
const en = {
  ...
  "privacy.healthPurpose": "Future app recommendations may use sleep or calorie signals only after permission.",
  "privacy.healthStorage": "The web demo does not read health data. Future profiles are device-local by default.",
...
const zhCN: Record<MessageKey, string> = {
  ...
  "privacy.healthPurpose": "未来 App 只会在获得许可后使用睡眠或热量信号改善推荐。",
  "privacy.healthStorage": "网页演示不读取健康数据；未来画像默认仅保存在设备上。",
