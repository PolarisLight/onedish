...
export function NearbyPage() {
  ...
  async function locate() {
    setBusy(true);
    try { const point = await requestCurrentLocation({ timeoutMs: 8_000 }); setCenter({ ...point, label: t("nearby.currentArea") }); setStatusKey("nearby.once"); }
